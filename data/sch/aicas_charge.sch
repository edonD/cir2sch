...
N 660 -250 660 -30 {lab=2}
N 660 -30 740 -30 {lab=2}
N 740 -30 740 30 {lab=2}
N 740 30 610 30 {lab=2}
...
C {devices/lab_pin.sym} 740 30 0 0 {name=l_1 sig_type=std_logic lab=1}
