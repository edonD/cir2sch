...
C {devices/vsource.sym} 440 -120 0 0 {name=VIP}
...
C {devices/lab_pin.sym} 440 -150 0 0 {name=l_Vinp sig_type=std_logic lab=Vinp}
C {devices/lab_pin.sym} 1020 -320 0 0 {name=l_Vinp sig_type=std_logic lab=Vinp}
