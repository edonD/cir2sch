...
value=3v}
C {devices/isource.sym} 960 -130 0 0 {name=IEE
value=0.1mA}
N 440 -160 440 -310 {lab=1}
N 440 -310 570 -310 {lab=1}
N 570 -160 570 -100 {lab=2}
N 570 -100 960 -100 {lab=2}
...
C {devices/lab_pin.sym} 960 -160 0 0 {name=l_13 sig_type=std_logic lab=13}
