...
value=0.0}
C {devices/vsource.sym} 740 0 0 0 {name=Vb
value=0.0}
...
C {devices/gnd.sym} 740 30 0 0 {name=l_0 lab=GND}
C {devices/lab_pin.sym} 740 -30 0 0 {name=l_b sig_type=std_logic lab=b}
