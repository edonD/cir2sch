...
N 770 -120 770 -300 {lab=6}
N 770 -120 770 60 {lab=6}
N 770 -120 990 -120 {lab=6}
N 990 -120 990 60 {lab=6}
N 990 -120 990 -300 {lab=6}
N 770 -120 550 -120 {lab=6}
N 550 -120 550 -300 {lab=6}
...
C {devices/iopin.sym} 400 -300 0 0 {name=p_能 lab=能}
C {devices/iopin.sym} 400 -260 0 0 {name=p_2 lab=2}
C {devices/iopin.sym} 400 -120 0 0 {name=p_せん lab=せん}
