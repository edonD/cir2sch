...
S {}
E {}
C {devices/isource.sym} 110 200 0 0 {name=IIN
value=0.0}
...
l=1U
model=M_PMOS_IDEAL}
C {devices/isource.sym} 240 200 0 0 {name=IREF
value=50UA}
...
N 390 -180 390 -430 {lab=4}
N 390 -430 310 -430 {lab=4}
...
C {devices/lab_pin.sym} 110 170 0 0 {name=l_13 sig_type=std_logic lab=13}
...
C {devices/lab_pin.sym} 240 170 0 0 {name=l_7 sig_type=std_logic lab=7}
