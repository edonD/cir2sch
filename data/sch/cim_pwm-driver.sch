...
model=sky130_fd_pr__pfet_01v8
spiceprefix=X}
C {devices/nmos4.sym} 720 -220 0 0 {name=XMn3
w=4u
l=0.15u
model=sky130_fd_pr__nfet_01v8
spiceprefix=X}
...
model=sky130_fd_pr__pfet_01v8
spiceprefix=X}
C {devices/capa.sym} 860 -250 0 0 {name=Cload
value=100f}
...
N 500 -220 700 -220 {lab=n2}
N 700 -220 700 -400 {lab=n2}
N 700 -400 720 -400 {lab=n2}
N 740 -250 740 -280 {lab=wl}
N 740 -280 860 -280 {lab=wl}
N 740 -250 740 -430 {lab=wl}
N 740 -430 760 -430 {lab=wl}
...
C {devices/gnd.sym} 860 -220 0 0 {name=l_0 lab=GND}
...
C {devices/gnd.sym} 740 -190 0 0 {name=l_vss lab=VSS}
