...
C {devices/vsource.sym} 220 -10 0 0 {name=Vdd
value=1.8}
C {devices/vsource.sym} 350 -10 0 0 {name=Vss
value=0}
C {devices/vsource.sym} 480 -10 0 0 {name=Vclk
value=PULSE(0}
C {devices/vsource.sym} 610 -10 0 0 {name=Vin0
value=0}
C {devices/vsource.sym} 220 120 0 0 {name=Vin1
value=0}
C {devices/vsource.sym} 350 120 0 0 {name=Vin2
value=0}
C {devices/vsource.sym} 480 120 0 0 {name=Vin3
value=0}
C {devices/vsource.sym} 610 120 0 0 {name=Vpwm
value=1.8}
...
C {devices/vdd.sym} 220 -40 0 0 {name=l_vdd lab=VDD}
...
C {devices/gnd.sym} 220 20 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 350 20 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 480 20 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 610 20 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 220 150 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 350 150 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 480 150 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 610 150 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 900 -130 0 0 {name=l_0 lab=GND}
C {devices/gnd.sym} 350 -40 0 0 {name=l_vss lab=VSS}
...
C {devices/lab_pin.sym} 480 -40 0 0 {name=l_clk sig_type=std_logic lab=clk}
C {devices/lab_pin.sym} 610 -40 0 0 {name=l_in0 sig_type=std_logic lab=in0}
C {devices/lab_pin.sym} 220 90 0 0 {name=l_in1 sig_type=std_logic lab=in1}
C {devices/lab_pin.sym} 350 90 0 0 {name=l_in2 sig_type=std_logic lab=in2}
C {devices/lab_pin.sym} 480 90 0 0 {name=l_in3 sig_type=std_logic lab=in3}
C {devices/lab_pin.sym} 610 90 0 0 {name=l_pwm_in sig_type=std_logic lab=pwm_in}
