...
model=sky130_fd_pr__nfet_01v8
spiceprefix=X}
C {devices/isource.sym} -160 180 0 0 {name=I0
value=20u}
...
C {devices/vdd.sym} -160 150 0 0 {name=l_VDD lab=VDD}
C {devices/lab_pin.sym} -160 210 0 0 {name=l_Ibias sig_type=std_logic lab=Ibias}
C {devices/ipin.sym} -280 -280 0 0 {name=p_Vinp lab=Vinp}
C {devices/ipin.sym} -280 -240 0 0 {name=p_Vinn lab=Vinn}
C {devices/opin.sym} 560 -290 0 0 {name=p_Vout lab=Vout}
