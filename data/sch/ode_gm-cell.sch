...
model=sky130_fd_pr__nfet_01v8
spiceprefix=X}
C {devices/res.sym} 340 70 0 0 {name=Rs1
value=4.1k}
C {devices/res.sym} 340 150 0 0 {name=Rs2
value=4.1k}
...
N 130 -120 130 40 {lab=s1}
N 130 40 340 40 {lab=s1}
N 310 -180 310 -430 {lab=outp}
N 310 -120 340 -120 {lab=s2}
N 340 -120 340 120 {lab=s2}
N 340 100 340 180 {lab=ntail}
N 340 100 340 0 {lab=ntail}
