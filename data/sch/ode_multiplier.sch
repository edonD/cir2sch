...
value=1k}
C {devices/res.sym} 640 -240 0 0 {name=Rax3
value=4k}
C {devices/res.sym} 720 -160 0 0 {name=Rax4
value=1k}
C {devices/res.sym} 190 -110 0 0 {name=Ray1
value=1.25k}
C {devices/res.sym} 340 -30 0 0 {name=Ray2
value=1k}
C {devices/res.sym} 580 -110 0 0 {name=Ray3
value=1.25k}
C {devices/res.sym} 480 -30 0 0 {name=Ray4
value=1k}
...
model=sky130_fd_pr__nfet_01v8
spiceprefix=X}
C {devices/res.sym} 340 70 0 0 {name=Rdeg1
value=0.6k}
C {devices/res.sym} 340 150 0 0 {name=Rdeg2
value=0.6k}
...
N 460 -130 460 0 {lab=vcm}
N 460 0 480 0 {lab=vcm}
N 480 0 340 0 {lab=vcm}
N 460 -130 720 -130 {lab=vcm}
N 640 -210 640 -190 {lab=xn_int}
N 640 -190 720 -190 {lab=xn_int}
N 720 -190 720 -280 {lab=xn_int}
N 720 -280 800 -280 {lab=xn_int}
N 640 -210 640 -280 {lab=xn_int}
N 640 -280 410 -280 {lab=xn_int}
N 190 -80 190 -60 {lab=yp_int}
N 190 -60 340 -60 {lab=yp_int}
N 190 -80 190 -150 {lab=yp_int}
N 190 -150 90 -150 {lab=yp_int}
N 580 -80 580 -60 {lab=yn_int}
N 580 -60 480 -60 {lab=yn_int}
N 480 -60 480 -150 {lab=yn_int}
N 480 -150 350 -150 {lab=yn_int}
N 240 0 240 100 {lab=tail_node}
N 240 100 340 100 {lab=tail_node}
N 340 100 340 180 {lab=tail_node}
N 130 -180 130 -250 {lab=mid1}
N 130 -250 190 -250 {lab=mid1}
N 190 -250 370 -250 {lab=mid1}
N 130 -120 130 40 {lab=src_b1}
N 130 40 340 40 {lab=src_b1}
N 310 -120 340 -120 {lab=src_b2}
N 340 -120 340 120 {lab=src_b2}
...
C {devices/lab_pin.sym} 640 -270 0 0 {name=l_xn sig_type=std_logic lab=xn}
C {devices/lab_pin.sym} 190 -140 0 0 {name=l_yp sig_type=std_logic lab=yp}
C {devices/lab_pin.sym} 580 -140 0 0 {name=l_yn sig_type=std_logic lab=yn}
...
C {devices/ipin.sym} -10 -95 0 0 {name=p_vcm lab=vcm}
C {devices/iopin.sym} -10 -240 0 0 {name=p_xp lab=xp}
C {devices/iopin.sym} -10 -200 0 0 {name=p_xn lab=xn}
C {devices/iopin.sym} -10 -30 0 0 {name=p_yp lab=yp}
C {devices/iopin.sym} -10 90 0 0 {name=p_yn lab=yn}
