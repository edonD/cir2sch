...
C {devices/res.sym} 420 -280 0 0 {name=Rax1
value=4k}
C {devices/res.sym} 570 -280 0 0 {name=Rax2
value=1k}
C {devices/res.sym} 900 -280 0 0 {name=Rax3
value=4k}
C {devices/res.sym} 1040 -280 0 0 {name=Rax4
value=1k}
C {devices/res.sym} 190 -150 0 0 {name=Ray1
value=1.25k}
C {devices/res.sym} 710 -220 0 0 {name=Ray2
value=1k}
C {devices/res.sym} 470 -150 0 0 {name=Ray3
value=1.25k}
C {devices/res.sym} 840 -200 0 0 {name=Ray4
value=1k}
...
value=14k}
N 420 -250 420 -280 {lab=xp_int}
N 420 -280 540 -280 {lab=xp_int}
N 540 -280 540 -310 {lab=xp_int}
N 540 -310 570 -310 {lab=xp_int}
N 420 -250 420 -280 {lab=xp_int}
N 420 -280 150 -280 {lab=xp_int}
N 570 -250 570 -190 {lab=vcm}
N 570 -190 710 -190 {lab=vcm}
N 710 -190 710 -170 {lab=vcm}
N 710 -170 840 -170 {lab=vcm}
N 840 -170 840 -250 {lab=vcm}
N 840 -250 1040 -250 {lab=vcm}
N 900 -250 900 -280 {lab=xn_int}
N 900 -280 800 -280 {lab=xn_int}
N 900 -250 900 -310 {lab=xn_int}
N 900 -310 1040 -310 {lab=xn_int}
...
C {devices/lab_pin.sym} 420 -310 0 0 {name=l_xp sig_type=std_logic lab=xp}
C {devices/lab_pin.sym} 900 -310 0 0 {name=l_xn sig_type=std_logic lab=xn}
C {devices/lab_pin.sym} 190 -180 0 0 {name=l_yp sig_type=std_logic lab=yp}
C {devices/lab_pin.sym} 710 -250 0 0 {name=l_yp_int sig_type=std_logic lab=yp_int}
C {devices/lab_pin.sym} 470 -180 0 0 {name=l_yn sig_type=std_logic lab=yn}
...
C {devices/iopin.sym} -10 -280 0 0 {name=p_xp lab=xp}
C {devices/iopin.sym} -10 -200 0 0 {name=p_xn lab=xn}
C {devices/iopin.sym} -10 -150 0 0 {name=p_yp lab=yp}
C {devices/iopin.sym} -10 -110 0 0 {name=p_yn lab=yn}
C {devices/opin.sym} 1200 -370 0 0 {name=p_outp lab=outp}
C {devices/opin.sym} 1200 -330 0 0 {name=p_outn lab=outn}
