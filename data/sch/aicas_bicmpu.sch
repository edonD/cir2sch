...
value=0.0V}
C {devices/vsource.sym} 220 -120 0 0 {name=VB
value=0.0V}
...
N 220 -150 220 -430 {lab=5}
N 220 -430 240 -430 {lab=5}
...
C {devices/lab_pin.sym} 220 -90 0 0 {name=l_15 sig_type=std_logic lab=15}
